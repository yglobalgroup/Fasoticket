...
t.add("Mail server test email", "Prueba del servidor de correo", "javascript", "es");
...
t.add("Send", "Enviar", "javascript", "es");
...
t.add("Today", "Hoy dia", "javascript", "es");
t.add("Unstick", "Despegar", "javascript", "es");
t.add("Week", "Semana", "javascript", "es");
t.add("days", "dias", "javascript", "es");
t.add("days.Fri", "Vie", "javascript", "es");
t.add("days.Mon", "Lun", "javascript", "es");
t.add("days.Sat", "S\u00e1b", "javascript", "es");
t.add("days.Sun", "Dom", "javascript", "es");
t.add("days.Thu", "Jue", "javascript", "es");
t.add("days.Tue", "Mar", "javascript", "es");
t.add("days.Wed", "Mi\u00e9", "javascript", "es");
